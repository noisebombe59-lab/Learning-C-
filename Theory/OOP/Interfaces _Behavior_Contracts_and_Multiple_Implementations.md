Interfaces (Контракты) — «Когда мне не важно, как работает объект, важно лишь, что он умеет делать (например, "мне всё равно, как ты сохраняешь данные, просто реализуй метод Save()")».
