Polymorphism (Virtual/Override) — «Когда я хочу вызвать один метод, но получить разный результат в зависимости от того, какой объект перед нами (Кнопка "Печать" печатает чек для клиента и отчет для админа по-разному)».
