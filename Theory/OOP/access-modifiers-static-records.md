...
Records — «Когда мне нужен простой и защищенный контейнер для данных, который умеет красиво печататься в консоль и легко сравниваться с другими такими же контейнерами».
