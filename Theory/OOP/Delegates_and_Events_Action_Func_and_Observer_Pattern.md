Delegates, Events, Action/Func — «Когда я хочу, чтобы один объект мог сообщить другим о том, что что-то случилось (например, "Транзакция завершена"), не зная ничего о тех, кто его слушает».
Observer Pattern — «Когда мне нужно создать систему подписок: например, при изменении баланса нужно одновременно отправить SMS, Email и обновить лог».
