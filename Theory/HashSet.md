HashSet — «Когда мне нужно хранить только уникальные элементы и мгновенно проверять, есть ли такой элемент в списке (работает в разы быстрее, чем List.Contains)».
